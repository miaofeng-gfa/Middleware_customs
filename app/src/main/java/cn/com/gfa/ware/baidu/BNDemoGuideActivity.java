...
import com.baidu.navisdk.adapter.BNRouteGuideManager.VoiceMode;
...
//		BNRouteGuideManager.getInstance().setVoiceModeInNavi(VoiceMode.Veteran);//包括新手，老手，和静音三种模式。
	}
	...
	private void addCustomizedLayerItems() {
		...
		if (mBNRoutePlanNode != null) {//getResources().getDrawable(R.drawable.ic_launcher)
